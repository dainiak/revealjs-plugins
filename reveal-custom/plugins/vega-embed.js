...
const RevealVega = {
    ...
    init: (reveal) => {
        ...
        options = {
            ...
            urls: {
				vega: options.urls && options.urls.vega || 'https://cdnjs.cloudflare.com/ajax/libs/vega/5.29.0/vega.min.js',
				vegaLite: options.urls && options.urls.vegaLite || 'https://cdnjs.cloudflare.com/ajax/libs/vega-lite/5.18.1/vega-lite.min.js',
